...
public class ChatDao {
	 ...
	 */
	public List<Map<String, Object>> queryMessListByToken(String token)
		...
		return dao.executeQueryForList(sql, new int[] { Types.INTEGER, Types.INTEGER },
				new Object[] { Integer.parseInt(uid), Integer.parseInt(uid) });
	}
	 ...
	 * @throws NumberFormatException
	 */
	public int queryUnReadMessCount(String id, String toId)
			throws NumberFormatException, ClassNotFoundException, SQLException {
		String sql = "select count(*) count " + "from news where display=0 and isread=0 and "
				+ "resserid=? and recipients=? ";
		return Integer.parseInt(dao.executeQueryForMap(sql, new int[] { Types.INTEGER, Types.INTEGER },
				new Object[] { Integer.parseInt(toId), Integer.parseInt(id) }).get("count").toString());
	}
	 ...
	 * @throws NumberFormatException
	 */
	public List<Map<String, Object>> queryFixById(String formid, String toid)
			throws NumberFormatException, ClassNotFoundException, SQLException {
		...
		return dao.executeQueryForList(sql, new int[] { Types.INTEGER, Types.INTEGER, Types.INTEGER, Types.INTEGER },
				new Object[] { Integer.parseInt(formid), Integer.parseInt(toid), Integer.parseInt(toid),
	...
	public Map<String, Object> addMess(String uid, String targetid, String mess)
		...
		return dao.executeQueryForMap("select * from news where resserid=? and recipients=? and createtime=?",
				...
				new Object[] { Integer.parseInt(uid), Integer.parseInt(targetid), mill });
	}
	 ...
	 * @throws NumberFormatException
	 */
	public int updateIsRead(String uid, String targetid)
			throws NumberFormatException, ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		return dao.executeUpdate("update news set isread=1 where resserid=? and recipients=?",
				new int[] { Types.INTEGER, Types.INTEGER },
				new Object[] { Integer.parseInt(targetid), Integer.parseInt(uid) });
	}
	 ...
	 * @throws NumberFormatException
	 */
	public int updateIsReadById(String chatid)
			throws NumberFormatException, ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		return dao.executeUpdate("update news set isread=1 where chatid=?", new int[] { Types.INTEGER },
				new Object[] { Integer.parseInt(chatid) });
	}
	 ...
	 * @throws NumberFormatException
	 */
	public List<Map<String, Object>> queryNewsById(String uid, String targetid)
			throws NumberFormatException, ClassNotFoundException, SQLException {
		String sql = "select * from news "
				+ "where display=0 and (resserid=? and recipients=?) or (resserid=? and recipients=?) "
				+ "ORDER BY createtime desc ";
		return dao.executeQueryForList(sql, new int[] { Types.INTEGER, Types.INTEGER, Types.INTEGER, Types.INTEGER },
				new Object[] { Integer.parseInt(uid), Integer.parseInt(targetid), Integer.parseInt(targetid),
	 ...
	 * @throws NumberFormatException
	 */
	public Map<String, Object> queryNewsById(String chatid)
			throws NumberFormatException, ClassNotFoundException, SQLException {
		return dao.executeQueryForMap("select * from news where chatid=?", new int[] { Types.INTEGER },
				new Object[] { Integer.parseInt(chatid) });
	}
	 ...
	 * @throws NumberFormatException
	 */
	public Map<String, Object> queryTokenByid(String targetid)
			throws NumberFormatException, ClassNotFoundException, SQLException {
		return dao.executeQueryForMap("select * from userlogin where uid=?", new int[] { Types.INTEGER },
				new Object[] { Integer.parseInt(targetid) });
	}
