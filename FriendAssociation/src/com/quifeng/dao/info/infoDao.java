...
public class infoDao {
	...
	public int updateHeadImage(String uid, String useravatar)
			throws NumberFormatException, ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		return dao.executeUpdate("update user set useravatar=? where uid=?", new int[] { Types.VARCHAR, Types.INTEGER },
				new Object[] { useravatar, Integer.parseInt(uid) });
	}
