...
//	private static final String OPENCV_XML_PATH = "E:\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml";
	...
	/**
	 * 计算居中裁剪框 在原图边界范围内，以检测的人脸框为中心，向四周等比例放大，最大的裁剪框可保证人脸居中
	 * 
	...
	public static Rect estimateCenterCropBox(int srcWidth, int srcHeight, Rect rect) {
		...
		return new Rect(rect.x - ret, rect.y - ret * rect.height / rect.width, rect.width + 2 * ret,
				rect.height + 2 * ret * rect.height / rect.width);
	}
