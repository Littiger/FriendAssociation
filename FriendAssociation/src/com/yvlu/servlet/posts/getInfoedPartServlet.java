 ...
 * @time   2021年2月3日
 */
public class getInfoedPartServlet {

	postsDao postsDao = new postsDao();
	
	public void getInfoedPart(HttpServletRequest request, HttpServletResponse response) {
		// json对象
		...
		try {
			...
			//获取帖子
			List<Map<String, Object>> posts = postsDao.getPartPosts(word);
