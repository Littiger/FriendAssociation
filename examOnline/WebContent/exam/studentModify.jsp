					...
					<table width="950" border="0" cellpadding="0" cellspacing="0" align="center">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="word_grey">&nbsp;
											...
											当前位置：→ <span class="word_darkGrey">修改个人资料 &gt;&gt;&gt;</span>
										</td>
										<td align="right">
						...
						<tr>
							<td align="center" valign="top">
								...
								<form name="studentForm" action="<%=request.getContextPath() %>/exam/studentOK.jsp" method="post" onsubmit="return checkForm(studentForm)">
									...
									<table width="57%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr>
											...
											<td align="left">
												<input type="hidden" name="ID" value="CN20191227000008"/> 
												<input type="text" name="name" value="sdfsdfsdfsdf" readonly/>*
											</td>
										</tr>
										<tr>
											<td align="left" style="padding: 5px;">原&nbsp;密&nbsp;码：</td>
											<td align="left">
												<input type="hidden" name="holdpwd" value="2234234"/> 
												<input type="password" name="oldpwd" value="123456" />*	
											</td>
										</tr>
										<tr>
											<td height="30" align="left" style="padding: 5px;">新&nbsp;密&nbsp;码：</td>
											<td align="left">
												<input type="password" name="pwd" value="123456" />（密码由6到20位的数字或字母组成） *
											</td>
										</tr>
										<tr align="center">
										...
										<tr align="center">
											...
											<td width="80%" align="left">
												<input type="text" name="question" value="123456" />（如我的生日）*
											</td>
										</tr>
										<tr align="center">
											<td width="20%" height="30" align="left" style="padding: 5px;">问题答案：</td>
											<td width="80%" align="left">
												<input type="text" name="answer" value="123456" size="40"/>（如7月17日）*
											</td>
										</tr>
										<tr align="center">
											<td width="20%" height="30" align="left" style="padding: 5px;">专&nbsp;&nbsp;&nbsp;&nbsp;业：</td>
											<td width="80%" align="left">
												<input type="text" name="profession" value="123456" size="40"/>
											</td>
										</tr>
										<tr align="center">
											<td width="20%" height="30" align="left" style="padding: 5px;">身份证号：</td>
											<td width="80%" align="left">
												<input type="text" name="cardNo" value="123456" size="40"/>*
											</td>
										</tr>
										<tr>
											...
											<td align="left">
												...
												<input type="button" value=" 返回 " class="btn_grey" onclick="window.location.href='<%=request.getContextPath() %>/exam/main.jsp'" />&nbsp;
											</td>
										</tr>
									</table>
								</form>
