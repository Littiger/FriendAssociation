					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="78%" class="word_grey" align="left">
											&nbsp;当前位置：<span class="word_darkGrey">班级信息管理 &gt;&gt; 添加班级信息&gt;&gt;</span>
										</td>
										<td align="right">
						...
						<tr>
							<td align="center" valign="top">
								...
								<form name="form1" method="post" action="<%=request.getContextPath() %>/manage/classs.do?method=add" onsubmit="return checkForm(form1)">
									<table width="96%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr align="center">
								    		...
								    		<td align="left">
								      			<input type="text" name="classs_name" size="30" value="">
									  		</td>
										</tr>
								    	<tr>
