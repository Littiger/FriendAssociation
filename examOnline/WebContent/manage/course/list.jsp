								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="78%" class="word_grey">
											&nbsp;当前位置：<span class="word_darkGrey">课程信息管理 &gt;&gt;&gt;</span>
										</td>
										<td align="right">
								...
								<table width="96%" height="40" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td height="27" align="right">
											...
											<a href="<%=request.getContextPath()%>/manage/course.do?method=addpage">添加课程</a>&nbsp;&nbsp;
										</td>
									</tr>
								</table>
								
								<form name="studentForm" action="<%=request.getContextPath()%>/manage/course.do?method=delete" method="post" style="margin: 0px">
									<table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
											...
											<c:forEach var="map" varStatus="i" begin="0" end="${fn:length(list)-1}" items="${list}" >
												
											<tr>
											 	<td align="center">${i.count}</td> 
											    <td style="padding:5px;">${map.course_name}</td>
												<td align="center">${map.course_time}</td>
											    <td align="center"><input type="checkbox" name="delIdArray" value="${map.course_id}" class="noborder"></td>
											</tr>
