					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								<form action="<%=request.getContextPath() %>/manage/examinee.do?method=conditionquery" method="post" style="margin: 0px">
								<table width="96%" height="40" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td align="left" valign="middle">&nbsp;
											所在班级： 
											<select name="classs_name">
											...
											&nbsp;考生姓名： 
											<input type="text" name="examinee_name"/>&nbsp;&nbsp; 
								...
								<form name="studentForm" action="<%=request.getContextPath() %>/manage/examinee.do?method=delete" method="post" style="margin: 0px">
									<table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
										...
										<tr>
										 	<td align="center"><%=map.get("examinee_id") %></td> 
										    <td style="padding:5px;"><%=map.get("examinee_name") %></td>
											<td align="center"><%=map.get("examinee_sex") %></td>
											<td align="center"><%=map.get("examinee_time") %></td>
										    <td align="center"><%=map.get("examinee_question") %></td>	
										    <td align="center"><%=map.get("examinee_identity") %></td>
										    <td align="center"><input type="checkbox" name="delIdArray" value="<%=map.get("examinee_id") %>" class="noborder"></td>
										</tr>
