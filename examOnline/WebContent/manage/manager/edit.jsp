					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								...
								<form name="form1" method="post" action="<%=request.getContextPath() %>/manage/manager.do?method=edit" onsubmit="return checkForm(form1)" enctype="multipart/form-data">
									<table width="96%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr>
										<td align="left">
								      			<input type="text" name="pass" size="30" value="<%=map.get("manager_id")%>" style="visibility: hidden;" >
									  		</td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">管理员名称：</td>
								    		<td align="left">
								      			<input type="text" name="name" size="30" value="<%=map.get("manager_name") %>">
									  		</td>
									  		<td rowspan="3"><img id="preview"   style="width:130px;height:130px"  src="<%=request.getContextPath()%>/Images/dp.png"  /></td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">密码：</td>
								    		<td align="left">
								      			<input type="text" name="manager_password" size="30" value="<%=map.get("manager_pass")%>">
									  		</td>
										</tr>
										<tr>
								         <td>管理员头像：</td>
								    	...
								    	<tr>
								      		...
								      		<td align="left">
								      			<input type="submit" name="submit" value=" 更新 " class="btn_grey">
												&nbsp;
