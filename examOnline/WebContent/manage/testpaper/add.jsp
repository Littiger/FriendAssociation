					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="78%" class="word_grey" align="left">
											&nbsp;当前位置：<span class="word_darkGrey">试卷信息管理 &gt;&gt;添加试卷信息&gt;&gt;</span>
										</td>
										<td align="right">
						...
						<tr>
							<td align="center" valign="top">
								...
								<form name="form1" method="post" action="<%=request.getContextPath() %>/manage/testpaper.do?method=add" onsubmit="return checkForm(form1)">
									<table width="96%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr align="center">
								    		...
								    		<td align="left">
								      			<input type="text" name="testpaper_name" size="30" value="">
									  		</td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">单选题数量：</td>
								    		<td align="left">
								      			<input type="text" name="testpaper_radio_num" size="30" value="10">
									  		</td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">多选题数量：</td>
								    		<td align="left">
								      			<input type="text" name="testpaper_check_num" size="30" value="10">
									  		</td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">考试用时(分钟)：</td>
								    		<td align="left">
								      			<input type="text" name="testpaper_time_use" size="30" value="20">
									  		</td>
										</tr>
										   <tr align="center">
								    		...
								    		<td align="left">
												<select name="classs_id">
													...
													<c:forEach  var="map"  varStatus="i"  items="${list_classs}">
													<option value="${map.classs_id}"    >${map.classs_name}</option>
													</c:forEach>
												</select>
									  		</td>
										</tr>
										<tr align="center">
								    		<td width="17%" height="30" align="left" style="padding:5px;">所属课程：</td>
								    		<td align="left">
												<select name="course_id" onchange="F_getTaoTi(this.value)">
													<option value="%">---请选择---</option>
													<c:forEach  var="map"  varStatus="i"   items="${list_course}">
													<option value="${map.course_id}">${map.course_name}</option>
													</c:forEach>
												</select>
									  		</td>
										</tr>
