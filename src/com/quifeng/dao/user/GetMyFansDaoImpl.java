...
public class GetMyFansDaoImpl {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getUserFansinfo(String uid) {
		String sql = "select uid,username,useravatar,useras from user where uid in (select formid from fixidez where toid = ? and display = 0)";
