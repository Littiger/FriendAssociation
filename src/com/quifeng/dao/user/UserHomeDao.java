...
public class UserHomeDao {
	...
	public Map<String, Object> getFixidezByID(String myId, String tid) {
		...
		try {
			data = dao.executeQueryForMap(sql, new int[] { Types.INTEGER, Types.INTEGER }, new Object[] { myId, tid });
	...
	public List<Map<String, Object>> getUserPostById(String userid, String page, String size) {
		...
		try {
			data = dao.executeQueryForList(sql, new int[] { Types.INTEGER, Types.INTEGER, Types.INTEGER },
					new Object[] { userid, countPage, size });
		} catch (ClassNotFoundException | SQLException e) {
			// TODO Auto-generated catch block
			System.out.println(e.getMessage());
		}
	...
	public Map<String, Object> getZan(String postid, String myUid) {
		...
		try {
			data = dao.executeQueryForMap(sql, new int[] { Types.INTEGER, Types.INTEGER },
					new Object[] { postid, myUid });
		} catch (ClassNotFoundException | SQLException e) {
			System.out.println(e.getMessage());
		}
	...
	public Map<String, Object> getPlacMap(String plackid) {
		...
		try {
			data = dao.executeQueryForMap(sql, new int[] { Types.INTEGER }, new Object[] { plackid });
		} catch (ClassNotFoundException | SQLException e) {
			// TODO Auto-generated catch block
			System.out.println(e.getMessage());
		}
